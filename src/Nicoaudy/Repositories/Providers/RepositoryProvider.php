...
namespace Nicoaudy\Repositories\Providers;

use Illuminate\Support\Composer;
use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\ServiceProvider;
use Nicoaudy\Repositories\Console\Commands\MakeCriteriaCommand;
use Nicoaudy\Repositories\Console\Commands\MakeRepositoryCommand;
use Nicoaudy\Repositories\Console\Commands\Creators\CriteriaCreator;
use Nicoaudy\Repositories\Console\Commands\Creators\RepositoryCreator;

/**
 * Class RepositoryProvider
 *
 * @package Nicoaudy\Repositories\Providers
 */
